...
def candidate_profile2():
    return render_template('candidate2/candidate/profile/index.html')
@app.route('/candidate2/career')
def career_info():
    return render_template('candidate2/candidate/profile/career-informations.html') 
@app.route('/candidate2/cv')
def cv():
    return render_template('candidate2/candidate/profile/cv-template.html') 
@app.route('/candidate2/resume')
def resume():
    return render_template('candidate2/candidate/profile/resume.html') 
@app.route('/candidate2/add_education')
def add_education():
    return render_template('candidate2/candidate/profile/add_education_modal.html') 
@app.route('/candidate2/add_experience')
def add_experience():
